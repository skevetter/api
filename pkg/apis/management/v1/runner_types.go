...
// +genclient:method=GetConfig,verb=get,subresource=config,result=github.com/skevetter/api/pkg/apis/management/v1.RunnerConfig
// +genclient:method=GetAccessKey,verb=get,subresource=accesskey,result=github.com/skevetter/api/pkg/apis/management/v1.RunnerAccessKey
