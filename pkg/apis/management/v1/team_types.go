...
// +genclient:method=ListClusters,verb=get,subresource=clusters,result=github.com/skevetter/api/pkg/apis/management/v1.TeamClusters
// +genclient:method=ListAccessKeys,verb=get,subresource=accesskeys,result=github.com/skevetter/api/pkg/apis/management/v1.TeamAccessKeys
