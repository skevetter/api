...
import (
	...
	apisstoragev1 "github.com/skevetter/api/pkg/apis/storage/v1"
	...
	storagev1 "github.com/skevetter/api/pkg/listers/storage/v1"
...
type DevPodWorkspacePresetInformer interface {
	...
	Lister() storagev1.DevPodWorkspacePresetLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.StorageV1().DevPodWorkspacePresets().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1().DevPodWorkspacePresets().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1().DevPodWorkspacePresets().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StorageV1().DevPodWorkspacePresets().Watch(ctx, options)
			},
		},
		&apisstoragev1.DevPodWorkspacePreset{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *devPodWorkspacePresetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisstoragev1.DevPodWorkspacePreset{}, f.defaultInformer)
}

func (f *devPodWorkspacePresetInformer) Lister() storagev1.DevPodWorkspacePresetLister {
	return storagev1.NewDevPodWorkspacePresetLister(f.Informer().GetIndexer())
}
