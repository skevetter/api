	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ManagementV1().DevPodEnvironmentTemplates().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ManagementV1().DevPodEnvironmentTemplates().Watch(context.TODO(), options)
			},
		},
		&managementv1.DevPodEnvironmentTemplate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *devPodEnvironmentTemplateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&managementv1.DevPodEnvironmentTemplate{}, f.defaultInformer)
}
