...
func (c *FakeNetworkPeers) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.NetworkPeer, err error) {
	emptyResult := &v1.NetworkPeer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootGetActionWithOptions(networkpeersResource, name, options), emptyResult)
	if obj == nil {
...
func (c *FakeNetworkPeers) List(ctx context.Context, opts metav1.ListOptions) (result *v1.NetworkPeerList, err error) {
	emptyResult := &v1.NetworkPeerList{}
	obj, err := c.Fake.
		Invokes(testing.NewRootListActionWithOptions(networkpeersResource, networkpeersKind, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
...
func (c *FakeNetworkPeers) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewRootWatchActionWithOptions(networkpeersResource, opts))
}
...
func (c *FakeNetworkPeers) Create(ctx context.Context, networkPeer *v1.NetworkPeer, opts metav1.CreateOptions) (result *v1.NetworkPeer, err error) {
	emptyResult := &v1.NetworkPeer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateActionWithOptions(networkpeersResource, networkPeer, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1.NetworkPeer), err
...
func (c *FakeNetworkPeers) Update(ctx context.Context, networkPeer *v1.NetworkPeer, opts metav1.UpdateOptions) (result *v1.NetworkPeer, err error) {
	emptyResult := &v1.NetworkPeer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateActionWithOptions(networkpeersResource, networkPeer, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1.NetworkPeer), err
...
func (c *FakeNetworkPeers) UpdateStatus(ctx context.Context, networkPeer *v1.NetworkPeer, opts metav1.UpdateOptions) (result *v1.NetworkPeer, err error) {
	emptyResult := &v1.NetworkPeer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceActionWithOptions(networkpeersResource, "status", networkPeer, opts), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1.NetworkPeer), err
...
func (c *FakeNetworkPeers) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	action := testing.NewRootDeleteCollectionActionWithOptions(networkpeersResource, opts, listOpts)
...
func (c *FakeNetworkPeers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1.NetworkPeer, err error) {
	emptyResult := &v1.NetworkPeer{}
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceActionWithOptions(networkpeersResource, name, pt, data, opts, subresources...), emptyResult)
	if obj == nil {
		return emptyResult, err
	}
	return obj.(*v1.NetworkPeer), err
