...
type DevPodWorkspaceTemplateLister interface {
	...
	List(selector labels.Selector) (ret []*managementv1.DevPodWorkspaceTemplate, err error)
	// Get retrieves the DevPodWorkspaceTemplate from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*managementv1.DevPodWorkspaceTemplate, error)
...
type devPodWorkspaceTemplateLister struct {
	listers.ResourceIndexer[*managementv1.DevPodWorkspaceTemplate]
}
...
func NewDevPodWorkspaceTemplateLister(indexer cache.Indexer) DevPodWorkspaceTemplateLister {
	return &devPodWorkspaceTemplateLister{listers.New[*managementv1.DevPodWorkspaceTemplate](indexer, managementv1.Resource("devpodworkspacetemplate"))}
}
