...
type DevPodWorkspaceInstanceLister interface {
	...
	List(selector labels.Selector) (ret []*managementv1.DevPodWorkspaceInstance, err error)
...
type devPodWorkspaceInstanceLister struct {
	listers.ResourceIndexer[*managementv1.DevPodWorkspaceInstance]
}
...
func NewDevPodWorkspaceInstanceLister(indexer cache.Indexer) DevPodWorkspaceInstanceLister {
	return &devPodWorkspaceInstanceLister{listers.New[*managementv1.DevPodWorkspaceInstance](indexer, managementv1.Resource("devpodworkspaceinstance"))}
}

// DevPodWorkspaceInstances returns an object that can list and get DevPodWorkspaceInstances.
func (s *devPodWorkspaceInstanceLister) DevPodWorkspaceInstances(namespace string) DevPodWorkspaceInstanceNamespaceLister {
	return devPodWorkspaceInstanceNamespaceLister{listers.NewNamespaced[*managementv1.DevPodWorkspaceInstance](s.ResourceIndexer, namespace)}
}
...
type DevPodWorkspaceInstanceNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*managementv1.DevPodWorkspaceInstance, error)
