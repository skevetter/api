...
type SharedSecretLister interface {
	...
	List(selector labels.Selector) (ret []*storagev1.SharedSecret, err error)
...
type sharedSecretLister struct {
	listers.ResourceIndexer[*storagev1.SharedSecret]
}
...
func NewSharedSecretLister(indexer cache.Indexer) SharedSecretLister {
	return &sharedSecretLister{listers.New[*storagev1.SharedSecret](indexer, storagev1.Resource("sharedsecret"))}
}

// SharedSecrets returns an object that can list and get SharedSecrets.
func (s *sharedSecretLister) SharedSecrets(namespace string) SharedSecretNamespaceLister {
	return sharedSecretNamespaceLister{listers.NewNamespaced[*storagev1.SharedSecret](s.ResourceIndexer, namespace)}
}
...
type SharedSecretNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*storagev1.SharedSecret, error)
